...
$listingManager = ListingManager::getConstructor(Payable::getConstructor([]));
?>
<!DOCTYPE html>
...
<body>
    ...
    <div class="container-fluid d-flex justify-content-center">
        <form action="<?= $listingManager->getClassName() ?>" method="GET" class="row row-cols-lg-auto align-items-center g-2 p-2">
            ...
            <div class="col-12">
                <label class="visually-hidden" for="inlineFormInputGroupPayableCreatedAt"><?= _("Created At") ?></label>
                <div class="input-group">
                    <div class="input-group-text"><?= _("Created At") ?></div>
                    <input type="datetime-local" class="form-control" name="movementCreatedAt" id="inlineFormInputGroupPayableCreatedAt" value="<?= $_GET["movementCreatedAt"] ?? null ?>">
                    <div class="input-group-text"><?= _("To") ?></div>
                    <input type="datetime-local" class="form-control" name="movementCreatedAtEnd" id="inlineFormInputGroupPayableCreatedAtEnd" value="<?= $_GET["movementCreatedAtEnd"] ?? null ?>">
                </div>
            </div>
            ...
            <table class="table">
                ...
                <tbody>
                    <?php foreach ($listingManager->getRegistrations() as $movement): ?>
                        <?php
                        $movementObject = Payable::postConstructor($movement);
                        ?>
                        <tr>
