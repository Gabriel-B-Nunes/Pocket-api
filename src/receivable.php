...
$listingManager = ListingManager::getConstructor(Receivable::getConstructor([]));
?>
<!DOCTYPE html>
        ...
        <form action="<?= $listingManager->getClassName() ?>" method="GET" class="row row-cols-lg-auto align-items-center g-2 p-2">
            <div class="col-12">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="movementId" id="inlineFormInputGroupMovementId" value="<?= $_GET["movementId"] ?? null ?>">
                </div>
            </div>
            ...
            <div class="col-12">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="movementDescription" id="inlineFormInputGroupMovementDescription" value="<?= $_GET["movementDescription"] ?? null ?>">
                </div>
            </div>
            ...
            <div class="col-12">
                ...
                <div class="input-group">
                    ...
                    <select class="form-select" name="movementRecurring" id="inlineFormInputGroupMovementRecurring">
                        <?php foreach (RecurringEnum::cases() as $case): ?>
                            <?php if (isset($_GET["movementRecurring"]) && $_GET["movementRecurring"] == $case->value): ?>
            ...
            <div class="col-12">
                ...
                <div class="input-group">
                    ...
                    <input type="date" class="form-control" name="movementIssueDate" id="inlineFormInputGroupMovementIssueDate" value="<?= $_GET["movementIssueDate"] ?? null ?>">
                    <div class="input-group-text"><?= _("To") ?></div>
                    <input type="date" class="form-control" name="movementIssueDateEnd" id="inlineFormInputGroupMovementIssueDateEnd" value="<?= $_GET["movementIssueDateEnd"] ?? null ?>">
                </div>
            </div>

            <div class="col-12">
                <label class="visually-hidden" for="inlineFormInputGroupReceivableCreatedAt"><?= _("Created At") ?></label>
                <div class="input-group">
                    <div class="input-group-text"><?= _("Created At") ?></div>
                    <input type="datetime-local" class="form-control" name="movementCreatedAt" id="inlineFormInputGroupReceivableCreatedAt" value="<?= $_GET["movementCreatedAt"] ?? null ?>">
                    <div class="input-group-text"><?= _("To") ?></div>
                    <input type="datetime-local" class="form-control" name="movementCreatedAtEnd" id="inlineFormInputGroupReceivableCreatedAtEnd" value="<?= $_GET["movementCreatedAtEnd"] ?? null ?>">
                </div>
            </div>
            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th scope="col"><?= _("Recurring?") ?></th>
                        <th scope="col"><?= _("Issue Date") ?></th>
                        <th scope="col"><?= _("Created At") ?></th>
                    </tr>
                </thead>
                <tbody>
                    <?php foreach ($listingManager->getRegistrations() as $movement): ?>
                        <?php
                        $movementObject = Receivable::postConstructor($movement);
                        ?>
                        <tr>
                            <th scope="row"><a class="link-primary" href="<?= $listingManager->getClassViewName() ?>?movementId=<?= $movementObject->getId() ?>"><?= $movementObject->getId() ?></a></th>
                            <td><?= $movementObject->getDescription() ?></td>
                            <td><?= $movementObject->getRecurring() ?></td>
                            <td><?= $movementObject->getIssueDate() ?></td>
                            <td><?= $movementObject->getCreatedAt() ?></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
